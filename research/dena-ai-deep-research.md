...
## 13. 補遺：並行エージェント調査で追加確認された重要項目

以下は4系統の並行調査（商用B2B / 社内導入 / イベント発信 / 戦略IR）で本編初版に足りなかった一次情報。詳細は同ディレクトリの個別レポートを参照。

### 13.1 追加の対外・グループAI製品

| 名称 | 概要 | 出典 |
|---|---|---|
| **ONSEI / ONSEI Pro** | 音声で認知機能をチェック。自治体・福利厚生・高齢者住宅向け。ONSEI Proは2026/4提供開始（日本テクトシステムズ） | https://dena.com/jp/news/5376/ |
| **Noxx（Knot）** | AIグローバル採用プラットフォーム。2026/4 DeNA完全子会社化 | https://dena.com/jp/news/5382/ |
| **バーチャル警備** | セコムが販売。DeNAはクラウド共同開発・音声合成・キャラ | https://dena.com/jp/news/4820/ |
| **ちばぎんCS × Devin** | AI Link経由の導入事例（最大82%工数削減の会社開示あり） | https://dena.com/jp/news/5372/ |
| **Pococha × OSHIAI** | ライバー公認AI。正式は2026夏頃予定 | https://dena.com/jp/news/5393/ |
| **KENNOライフアシスト** | 認知機能向け生活提案AI。MySOSにβ | https://dena.com/jp/news/5161/ |
| **BASE☆BLUE** | ベイスターズ観戦アプリのリアルタイムAI解説（Gemini系） | https://engineering.dena.com/blog/2025/10/starguide/ |

### 13.2 追加の社内システム

| 名称 | 概要 | 出典 |
|---|---|---|
| **ChatAI** | 2023〜のSlack×Azure OpenAI社内ChatGPT。SAI以前の全社LLM | Engineering / Docswell ITS |
| **Findout + Ledge** | IT/HR/総務ヘルプデスクAI。RAG精度50%→80%→90%超 | https://engineering.dena.com/blog/2025/10/findoutai_rag/ 等 |
| **NOA / P-NOA** | アラート対応エージェント | https://engineering.dena.com/blog/2025/08/inside-the-noa-1/ |
| **DAAQ** | QA向けAIツール戦略 | https://engineering.dena.com/blog/2025/12/dena-qa-ai-strategy/ |
| **Anjin** | UnityオートパイロットOSS | https://github.com/dena/anjin |
| **HandyRL** | 分散強化学習OSS | https://github.com/DeNA/HandyRL |
| **Hekaton / Model Serving** | Triton Inference Server共通推論基盤 | https://engineering.dena.com/blog/2024/09/hekaton-model-serving/ |
| **AIガバナンスコミッティ** | 法務・セキュリティ・IT戦略等横断 | https://engineering.dena.com/blog/2025/08/ai_journey_2/ |

### 13.3 発信チャネルの補足

| チャネル | 役割 |
|---|---|
| **YouTube DeNATech** | AI Day / TechCon / AI Talksの本丸。南場AIオールイン基調は高再生 |
| **DeNA × AI Talks #1–#8** | 2025/8〜月次meetup（スクランブルスクエア＋オンライン） |
| **事業家のDNA** | 事業家向け密着・対談。AI実装の物語化 |
| **@DeNAxAI_NEWS** | AI Talks等の告知 |

南場基調（2025）: https://www.youtube.com/watch?v=1veMnZUsn4I  
DeNATech: https://www.youtube.com/@DeNATech

### 13.4 戦略・IRの追加ポイント

- AIネイティブ新規: 決算資料で **toCオープンβ 4件、約30プロジェクト進行** と開示（会社発表）。
- QAコストは統合報告書で「年間数十億円規模」言及あり（半減インパクトの文脈）。
- 競合との差別化を南場が語る軸: **ドメイン深さ（〇〇×AI） / ベロシティ / GTM / フィジカルAI**。
- SoftBank・LINEヤフーとは戦場が違い、CyberAgentが最も近いピア、という整理が妥当。

### 13.5 個別レポート（本リポジトリ）

| ファイル | 内容 |
|---|---|
| `research/dena-ai-commercial-offerings-2026-07.md` | B2B製品・パートナー網羅 |
| `research/dena-internal-ai-adoption-2026.md` | 社内基盤・OSS・組織 |
| `research/dena-ai-events-public-content-2024-2026.md` | イベント・YouTube・外部登壇 |
| `research/dena-ai-strategy-2024-2026.md` | 経営発言・IR・競合 |
...
- 2026-07-22: §13補遺。ONSEI/Noxx/Findout/AI Talks/DeNATech等を追加。
